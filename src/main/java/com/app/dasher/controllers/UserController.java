...
public class UserController {
  ...
  public Mono<ResponseEntity<ResponseDto<Object>>> requestOtp(
      @RequestBody OtpRequestDto otpRequestDto, @PathVariable String userId) {
    return Mono
  ...
  public Mono<ResponseEntity<ResponseDto<Object>>> confirmOtp(@PathVariable String userId,
  ...
  public Mono<ResponseEntity<ResponseDto<Object>>> updatePreferences(
      @RequestBody UserPreferencesDto userPreferencesDto, @PathVariable String userId) {
    return Mono
